  ...
  const committeeGroups: CommitteeGroup[] = [
    ...
    },
    {
      ...
      members: [
        ...
        { name: "Apurva Kahare", affiliation: "MEMS, IIT Indore" },
    ...
    },
    {
      ...
      members: [
        ...
        { name: "Aniruddha Vibhute", affiliation: "MEMS, IIT Indore" },
    ...
    },
    {
      role: "Awards",
      members: [
        { name: "Saurav Kumar Dubey", affiliation: "Phys, IIT Indore (C)" },
        { name: "Soumi Mukherjee", affiliation: "MEMS, IIT Indore" },
        { name: "Shyam Lal Gurjar", affiliation: "MEMS, IIT Indore" },
