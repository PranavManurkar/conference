...
"""
Management command to backfill Google Sheet with all previously approved registrations.
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Query ALL registrations (all statuses: Under Process, Accepted, Rejected)
