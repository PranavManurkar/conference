    ...
    <nav className="sticky top-0 z-50">
      ...
      <div className="bg-[color:var(--primary)]/10 text-[color:var(--nav)] text-sm sm:text-base">
        <div className="mx-auto max-w-7xl px-4 py-3 text-center">
         Workshop Registration deadline has been extended until 
          <span className="text-red-600 font-semibold"> 20th </span> June 2026. We are accepting online registrations only.
        </div>
      </div>
    </nav>
  );
